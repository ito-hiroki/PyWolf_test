...
public class LogdataToVector {
	...
	//出力
	private void outFile(String fileName, List<Integer[][]> results){
		try {
			FileWriter fileWriter = new FileWriter(fileName);
			PrintWriter bw = new PrintWriter(new BufferedWriter(fileWriter));

			// 始めにheader
			bw.print("wolforhuman");// 1
			bw.print(",");
			bw.print("deadoralive");// 2
			bw.print(",");
			bw.print("SEER_CO_num");// 3
			bw.print(",");
			bw.print("MEDIUM_CO_num");// 4
			bw.print(",");
			bw.print("recv_human_judge_num");// 5
			bw.print(",");
			bw.print("recv_wolf_judge_num");// 6
			bw.print(",");
			bw.print("SEER_CO_order");// 7
			bw.print(",");
			bw.print("MEDIUM_CO_order");// 8
			bw.print(",");
			bw.print("human_judge_num");// 9
			bw.print(",");
			bw.print("wolf_judge_num");// 10
			bw.print(",");
			bw.print("change_vote");// 11
			bw.print(",");
			bw.print("day");// 12
			bw.println();


			for(Integer[][] intArray2 : results){
